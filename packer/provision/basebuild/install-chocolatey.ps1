...
echo "wget $chocolatey_url -OutFile $localChocolateyPackageFilePath"
wget $chocolatey_url -OutFile $localChocolateyPackageFilePath

# based on local file, see above instructions for how you can obtain package
# from internal repository and download it local
#$localChocolateyPackageFilePath = 'c:\packages\chocolatey.0.10.7.nupkg'
