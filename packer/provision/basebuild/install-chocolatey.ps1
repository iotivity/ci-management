...
$chocolatey_version="0.10.8"
$chocolatey_nupkg="chocolatey.$chocolatey_version.nupkg"
$chocolatey_url="https://packages.chocolatey.org/$chocolatey_nupkg"
$download_dir="C:\packer\"

$localChocolateyPackageFilePath=$download_dir+$chocolatey_nupkg

echo "Invoke-WebRequest $chocolatey_url -OutFile $localChocolateyPackageFilePath"
Invoke-WebRequest $chocolatey_url -OutFile $localChocolateyPackageFilePath

# based on local file, see above instructions for how you can obtain package
# from internal repository and download it local
#$localChocolateyPackageFilePath = "c:\packages\chocolatey.$chocolatey_version.nupkg"
