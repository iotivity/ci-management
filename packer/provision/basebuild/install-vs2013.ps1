...
if (Test-Path "C:\Program Files (x86)\Microsoft Visual Studio 12.0\VC\bin\cl.exe") {
  echo "Visual Studio 2013 Installed"
}else{
  echo "installation of Visual Studio 2013 may not have been successful"
}
